        ...
        </div>
        {
          ...
          ? (
            <div className="pt-navbar-group pt-align-right">
              <Link className="pt-button pt-minimal pt-icon-music" to="/movies">Movies</Link>
              <Popover
                ...
                <button className="pt-button pt-minimal pt-icon-add" aria-label="add new movie"></button>
              </Popover>
